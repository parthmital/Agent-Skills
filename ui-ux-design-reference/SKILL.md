...
The search script lives inside this skill's own directory, not the project directory. Resolve the absolute path of this skill folder first, then replace `<skill-dir>` in the commands below with it. Do not assume a particular working directory:
