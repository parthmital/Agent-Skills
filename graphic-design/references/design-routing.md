...
| shadcn-tailwind-ui | Component implementation | SKILL.md + 7 references + 2 scripts |
...
| html-presentations | HTML presentations with Chart.js | SKILL.md + 4 references |
...
3. shadcn-tailwind-ui → Implement
...
3. shadcn-tailwind-ui → Update code
...
2. shadcn-tailwind-ui → Implement
...
**Brand:**
```bash
node ../brand-guidelines/scripts/inject-brand-context.cjs
node ../brand-guidelines/scripts/validate-asset.cjs <path>
```
...
Use **brand-guidelines + design-system + shadcn-tailwind-ui** when:
...
Use **logo-design + cip-design + html-presentations** when:
- Brand pitch: generate logo, create CIP mockups, build pitch deck

Use **banner-design + brand-guidelines** when:
...
Use **design-system + shadcn-tailwind-ui** when:
